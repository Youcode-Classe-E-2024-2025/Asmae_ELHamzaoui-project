...
<body class="bg-gray-50 min-h-screen flex items-center justify-center">
    ...
    <div class="w-[400px] bg-white p-6 rounded shadow-lg">
        ...
        <form method="POST">
            ...
            <button type="submit" name="modifier_projet" class="w-full bg-sky-700 text-white py-2 px-4 rounded hover:bg-yellow-600">Modifier le projet</button>
        </form>
    </div>
