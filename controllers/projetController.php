...
class ProjetController {
    ...
    public function ajouterProjet($nom, $desc, $date_debut, $date_fin, $visibilite, $photo_Projet) {
        if ($this->projetModel->ajouterProjet($nom, $desc, $date_debut, $date_fin, $visibilite, $photo_Projet)) {
    ...
    public function modifierProjet($id, $nom, $desc, $date_debut, $date_fin, $visibilite, $photo_Projet) {
        if ($this->projetModel->modifierProjet($id, $nom, $desc, $date_debut, $date_fin, $visibilite, $photo_Projet)) {
