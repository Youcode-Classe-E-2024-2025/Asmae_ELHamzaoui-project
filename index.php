    ...
    <header class="mx-4">
        <div class="container flex justify-between items-center">
            ...
            <div  class="flex space-x-8 items-center">
                ...
                <a href="views/publicProjects.php" class="text-2xl font-bold hover:text-gray-400" style="color:#24508c">Project</a>
            ...
            <div class="flex space-x-6 items-center mr-8"> <!-- Espacement égal entre les éléments -->
                ...
                <a href="views/direction.php" class="text-2xl  hover:text-gray-400" style="color:#24508c;font-weight:600;">
                   Sign up
                </a>
                
                <!-- Icône pour la connexion -->
                <a href="views/login.php" class="text-2xl  hover:text-gray-400" style="color:#24508c ;font-weight:600;">
                    log in
                </a>
            </div>
        </div>
